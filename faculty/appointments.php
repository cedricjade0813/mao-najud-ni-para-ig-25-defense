...
try {
    ...
    $count_queries = [
        ...
        'approved' => "SELECT COUNT(*) FROM appointments WHERE faculty_id = ? AND status IN ('approved', 'confirmed') AND date = ?",
        'declined' => "SELECT COUNT(*) FROM appointments WHERE faculty_id = ? AND status = 'declined' AND date = ?",
        'rescheduled' => "SELECT COUNT(*) FROM appointments WHERE faculty_id = ? AND status = 'rescheduled' AND date = ?"
    ];
