...
try {
    ...
    if (empty($faculty_name) && empty($faculty_id)) {
        throw new Exception('Faculty name or ID is required');
    }
    ...
    if (!empty($faculty_id)) {
        $vitalQuery .= "faculty_id = ?";
        $params[] = $faculty_id;
    } else {
        $vitalQuery .= "faculty_name = ?";
        $params[] = $faculty_name;
    }
    ...
    if (!empty($faculty_id)) {
        $referralQuery .= "faculty_id = ?";
        $referralParams[] = $faculty_id;
    } else {
        $referralQuery .= "faculty_name = ?";
        $referralParams[] = $faculty_name;
    }
